...
function createHeader() {
  ...
  caption.push('<span class="table-subcaption">Click on the <span style="color: #0000ff;">server address</span> to view detailed performance statistics for that server.</span><br />');
