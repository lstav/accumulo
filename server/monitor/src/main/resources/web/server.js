...
function sortTable(table, n) {
  var tableIDs = ["tServerDetail", "opHistoryDetails", "currentTabletOps", "perTabletResults"];
...
function createDetailHeader(server) {	
  ...
  items.push("<th class='firstcell' onclick='sortTable(0,0)'>Hosted&nbsp;Tablets&nbsp;</th>");
...
function createHistoryHeader() {	
  ...
  items.push("<th class='firstcell' onclick='sortTable(1,0)'>Operation&nbsp;</th>");
  items.push("<th onclick='sortTable(1,1)'>Success&nbsp;</th>");
  items.push("<th onclick='sortTable(1,2)'>Failure&nbsp;</th>");
  items.push("<th onclick='sortTable(1,3)'>Average<br />Queue&nbsp;Time&nbsp;</th>");
  items.push("<th onclick='sortTable(1,4)'>Std.&nbsp;Dev.<br />Queue&nbsp;Time&nbsp;</th>");
  items.push("<th onclick='sortTable(1,5)'>Average<br />Time&nbsp;</th>");
  items.push("<th onclick='sortTable(1,6)'>Std.&nbsp;Dev.<br />Time&nbsp;</th>");
  items.push("<th onclick='sortTable(1,7)'>Percentage&nbsp;Time&nbsp;Spent&nbsp;");
...
function createCurrentHeader() {	
  ...
  items.push("<th class='firstcell' onclick='sortTable(2,0)'>Minor&nbsp;Average&nbsp;</th>");
...
function createResultsHeader() {	
  ...
  caption.push("<span class='table-subcaption'>Per-tablet&nbsp;Details</span><br />");
  ...
  items.push("<th onclick='sortTable(3,10)'>Major&nbsp;Avg&nbsp;e/s&nbsp;</th>");
