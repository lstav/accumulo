  	...
  	<script type="text/javascript">
  		$.getJSON("rest/tservers", function(data) {
  			...
  			$.each(data.servers, function(key, val) {
  			  items.push("<td class='firstcell left'><a href='/tservers?s=" + val.id + "'>" + val.hostname + "</a></td>");
  			  items.push("<td class='right'>" + val.tablets + "</td>");
			  items.push("<td class='right'>" + val.lastContact + "</td>");
			  items.push("<td class='right'>" + val.entries + "</td>");
			  items.push("<td class='right'>" + val.ingest + "</td>");
			  items.push("<td class='right'>" + val.query + "</td>");
			  items.push("<td class='right'>" + val.holdtime + "</td>");
			  items.push("<td class='right'>" + val.compactions.scans.running + "&nbsp;(" + val.compactions.scans.queued + ")</td>");
			  items.push("<td class='right'>" + val.compactions.minor.running + "&nbsp;(" + val.compactions.minor.queued + ")</td>");
			  items.push("<td class='right'>" + val.compactions.major.running + "&nbsp;(" + val.compactions.major.queued + ")</td>");
			  ...
			  items.push("<td class='right'>" + val.osload + "</td>");
			});
